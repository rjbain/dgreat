 ...
 *
 * This service assumes VotingAPI schema fields:
...
final class VoteTallyService {
  ...
  public function __construct(
    ...
    private string $widgetCol  = 'rate_widget', // or 'type' if that's what your site uses
    private string $voteType   = 'post_votes'    // your Rate widget machine name
  ) {}

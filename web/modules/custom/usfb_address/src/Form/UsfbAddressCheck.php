...
class UsfbAddressCheck extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, AccountInterface $user = NULL) {
    ...
    $form['help'] = [
      '#markup' => t("Is this the physical address where you will be located while engaged in your program this semester? If so, please click <strong>Confirm</strong>. If not, or if no address is displayed below, click <strong>Update</strong>. Or click <strong>Skip</strong> and we'll prompt you again the next time you log in to myUSF.")
    ];

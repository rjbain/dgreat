 ...
 */
function usf_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['usf_example'] = [
  '#type'          => 'checkbox',
  '#title'         => t('usf sample setting'),
  '#default_value' => theme_get_setting('usf_example'),
